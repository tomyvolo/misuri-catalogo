import { getProductsByCategory, getCategories } from "@/lib/data" // Updated imports
...
export default async function CategoryProductsPage({ params }: CategoryProductsPageProps) {
  ...
  const filteredProducts = await getProductsByCategory(categorySlug) // Fetch from Supabase
